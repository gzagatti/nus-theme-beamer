...
\footercontent{
  ...
  ABC Conference 2025, Singapore --- XYZ-1234 \hfill
  \href{mailto:alyssa.p.turing@example.com}{alyssa.p.turing@example.com}}
    ...
    \begin{figure}
      ...
      \begin{tikzpicture}
        \begin{axis}[
            ...
            axis line style={-},
            ticks=none]
          \addplot[nus@orange] {sin(deg(x))};
          \addplot[nus@blue] {cos(deg(x))};
        \end{axis}
      \end{tikzpicture}
